...
class Callback:
    # база для колбэков. fit дёргает on_epoch_end после каждой эпохи.
    # logs - dict с метриками эпохи (loss, acc, val_loss, val_acc если есть).
    # если on_epoch_end вернёт True - обучение останавливается.
